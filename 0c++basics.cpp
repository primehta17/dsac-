...
//      int incpre=2;
//    int incbyonepre = ++inc;
//    cout << "incbyonepre" << incbyonepre <<endl;
//    cout << "inc value" << inc <<endl;
//    int incpost=2;
//    int incbyonepost = inc++;
//    cout << "incbyonepost" << incbyonepost <<endl;
//    cout << "inc value" << inc <<endl;
//     int decpre=2;
//    int decbyonepre = --inc;
//    cout << "decbyonepre" << decbyonepre <<endl;
//    cout << "inc value" << inc <<endl;
//     int decpost=2;
//    int decbyonepost = inc--;
//    cout << "decbyonepost" << decbyonepost <<endl;
//    cout << "inc value" << inc <<endl;
    ...
    // cout<<"The name of our first employee is "<< har.name << " and his salary is
    // "<<har.salary<<" Dollars"<<endl;
